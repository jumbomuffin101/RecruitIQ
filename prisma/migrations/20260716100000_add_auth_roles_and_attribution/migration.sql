...
ALTER TABLE "ApplicationStatusHistory" ADD COLUMN "changedByUserId" TEXT;
ALTER TABLE "InterviewResponse" ADD COLUMN "submittedByUserId" TEXT;
...
ALTER TABLE "InterviewResponse" ADD CONSTRAINT "InterviewResponse_submittedByUserId_fkey" FOREIGN KEY ("submittedByUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
